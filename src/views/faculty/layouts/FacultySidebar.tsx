...
function FacultySidebar({ isOpen, setIsOpen, isCollapsed }: SidebarProps) {
                  ...
                  <li key={link.href}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link to={link.href} className={`flex items-center gap-3 p-3 rounded-lg text-base transition ${active ? "bg-white/10 font-medium text-white" : "text-gray-300 hover:bg-white/5"} ${hideText ? 'justify-center' : ''}`}>
