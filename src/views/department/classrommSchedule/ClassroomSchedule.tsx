// src/views/department/classrommSchedule/ClassroomSchedule.tsx
  ...
  // --- EXPANDED DUMMY DATA ---
  // Times normalized to 12-hour blocks: 8:00 AM - 9:30 AM, 10:30 AM - 12:00 PM, 1:00 PM - 2:30 PM, 3:00 PM - 4:30 PM
  // Added facultyName alongside instructor for clarity/compatibility.
  const dummyClasses = [
  ...
  function ClassroomSchedule() {
    const [activeTab, setActiveTab] = useState('Full Schedule');
        ...
        <AnimatePresence>
          {isModalOpen && selectedClass && (
            <AssignmentModal
              ...
              availableRooms={dummyRooms.filter(r => r.available)}
            />
          )}
        </AnimatePresence>
      </div>
