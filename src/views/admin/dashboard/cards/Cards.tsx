...
function Cards() {
  return (
    <div className="grid grid-cols-4 md:grid-cols-2 gap-6 mb-8">
          {/* Total Faculty */}
          <div className="flex items-center gap-4 p-6 bg-white/80 rounded-xl shadow-lg border-l-4 border-violet-500">
          ...
          {/* Total Rooms */}
          <div className="flex items-center gap-4 p-6 bg-white/80 rounded-xl shadow-lg border-l-4 border-fuchsia-500">
          ...
          {/* Total Courses */}
          <div className="flex items-center gap-4 p-6 bg-white/80 rounded-xl shadow-lg border-l-4 border-purple-500">
          ...
          {/* Scheduled Classes */}
          <div className="flex items-center gap-4 p-6 bg-white/80 rounded-xl shadow-lg border-l-4 border-blue-500">
